...
public class BluetoothP2PActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bluetooth_p2p_activity);
            ...
            try {
                ...
                while(CONTINUE_READ_WRITE){
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(BluetoothP2PActivity.this, sb.toString(), Toast.LENGTH_LONG).show();
                        }
                    });
                }
